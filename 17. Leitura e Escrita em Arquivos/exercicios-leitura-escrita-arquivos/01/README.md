...
Na aula `Programação Assíncrona`, você implementou a API para cáculo de frete e na aula de hoje, você aprendeu que precisamos tratar a exceções em nosso código para que não tenhamos inconsistências no funcionamento das nossas API's.
