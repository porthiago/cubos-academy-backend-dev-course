...
const { verificarCamposObrigatoriosUsuarios } = require('../Utils/utils');
...
const cadastrarUsuario = async (req, res) => {
  const preenchimentoInválido = verificarCamposObrigatoriosUsuarios(req.body);

  if (preenchimentoInválido) {
    return res.status(400).json(preenchimentoInválido);
  }
