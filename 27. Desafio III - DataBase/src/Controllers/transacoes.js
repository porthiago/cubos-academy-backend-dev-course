...
const { verificarCamposObrigatoriosTransacoes } = require('../Utils/utils');
...
const cadastrarTransacao = async (req, res) => {
  ...
  const preenchimentoInvalido = verificarCamposObrigatoriosTransacoes(req.body);

  if (preenchimentoInvalido) {
    return res.status(400).json(preenchimentoInvalido);
  }
